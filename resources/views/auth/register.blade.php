            ...
            <div class="row text-center">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="form-login-register">
                        ...
                        @enderror
                        <input type="text" name="nrp" placeholder="NRP" class="@error('nrp') is-invalid @enderror" required>
                        @error('nrp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                        <input type="email" name="email" placeholder="Email Gooaya" class="@error('email') is-invalid @enderror"
                            autocomplete="email" required autocomplete="email">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
